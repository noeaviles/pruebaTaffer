...
const Video = ({ handleModal }) => {
  return (
    <section className="Video">
        <div className="Video-videoContainer" style={{ backgroundImage: `url(${video})`}} onClick={ handleModal }>
          <i className="fa-duotone fa-play Video-play"></i>
        </div>
